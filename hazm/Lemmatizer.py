...
class Lemmatizer(object):
    ...
    def __init__(
        ...
        tokenizer = WordTokenizer(
            words_file=default_words, verbs_file=verbs_file)
...
class Conjugation(object):
    ...
    def perfective_past(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ مطلق.
        """

        return [ri+x for x in ["م", "ی", "", "یم", "ید", "ند"]]

    def negative_perfective_past(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ مطلق به‌شکل منفی.
        """
        return ["ن"+x for x in self.perfective_past(ri)]

    def passive_perfective_past(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ مطلق در حالت مجهول.
        """

        return [ri+"ه "+x for x in self.perfective_past("شد")]

    def negative_passive_perfective_past(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ مطلق در حالت مجهول به‌شکل منفی.
        """

        return [ri+"ه "+x for x in self.negative_perfective_past("شد")]

    def imperfective_past(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پایا.
        """

        return ["می‌"+x for x in self.perfective_past(ri)]

    def negative_imperfective_past(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پایا به‌شکل منفی.
        """
        return ["ن"+x for x in self.imperfective_past(ri)]

    def passive_imperfective_past(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پایا در حالت مجهول.
        """

        return [ri+"ه "+x for x in self.imperfective_past("شد")]

    def negative_passive_imperfective_past(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پایا در حالت مجهول به‌شکل منفی.
        """

        return [ri+"ه "+x for x in self.negative_imperfective_past("شد")]

    def past_progresive(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ استمراری.
        """

        return [x+" "+y for x, y in zip(self.perfective_past('داشت'), self.imperfective_past(ri))]

    def passive_past_progresive(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ استمراری در حالت مجهول.
        """

        return [x+" "+y for x, y in zip(self.perfective_past("داشت"), self.passive_imperfective_past(ri))]

    def present_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال کامل.
        """

        return [ri+x for x in ["ه‌ام", "ه‌ای", "ه است", "ه", "ه‌ایم", "ه‌اید", "ه‌اند"]]

    def negative_present_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال کامل به‌شکل منفی.
        """
        return ["ن"+x for x in self.present_perfect(ri)]

    def subjunctive_present_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال کامل در وجه التزامی.
        """

        return [ri+"ه "+x for x in self.perfective_present("باش")]

    def negative_subjunctive_present_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال کامل در وجه التزامی به‌شکل منفی.
        """

        return ["ن"+x for x in self.subjunctive_present_perfect(ri)]
    
    def grammatical_present_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال کامل در وجه دستوری.
        """

        return [ri + "ه " + ("باش" if x == "باشی" else x) for x in self.perfective_present("باش")]

    def negative_grammatical_present_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال کامل در وجه دستوری به‌شکل منفی.
        """

        return ["ن"+ri + "ه " + ("باش" if x == "باشی" else x) for x in self.perfective_present("باش")]
    
    def passive_present_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال کامل در حالت مجهول.
        """

        return [ri+"ه "+x for x in self.present_perfect("شد")]

    def negative_passive_present_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال کامل در حالت مجهول به‌شکل منفی.
        """

        return [ri+"ه "+x for x in self.negative_present_perfect("شد")]

    def passive_subjunctive_present_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال کامل در وجه التزامی در حالت مجهول.
        """

        return [ri+"ه "+x for x in self.subjunctive_present_perfect("شد")]

    def negative_passive_subjunctive_present_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال کامل در وجه التزامی در حالت مجهول به‌شکل منفی.
        """

        return [ri+"ه "+x for x in self.negative_subjunctive_present_perfect("شد")]

    def passive_grammatical_present_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال کامل در وجه دستوری در حالت مجهول.
        """

        return [ri + "ه شده " + ("باش" if x == "باشی" else x) for x in self.perfective_present("باش")]

    def negative_passive_grammatical_present_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال کامل در وجه دستوری در حالت مجهول به‌شکل منفی.
        """

        return [ri + "ه نشده " + ("باش" if x == "باشی" else x) for x in self.perfective_present("باش")]
    
    def imperfective_present_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال کامل پایا.
        """

        return ["می‌" + x for x in self.present_perfect(ri)]

    def negative_imperfective_present_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال کامل پایا به‌شکل منفی.
        """
        return ["ن"+x for x in self.imperfective_present_perfect(ri)]

    def subjunctive_imperfective_present_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال کامل پایا در وجه التزامی.
        """

        return ["می‌"+x for x in self.subjunctive_present_perfect(ri)]
    
    def negative_subjunctive_imperfective_present_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال کامل پایا در وجه التزامی به‌شکل منفی.
        """

        return ["ن"+x for x in self.subjunctive_imperfective_present_perfect(ri)]
    
    def passive_imperfective_present_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال کامل پایا در حالت مجهول.
        """

        return [ri+"ه "+x for x in self.imperfective_present_perfect("شد")]

    def negative_passive_imperfective_present_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال کامل پایا در حالت مجهول به‌شکل منفی.
        """

        return [ri+"ه "+x for x in self.negative_imperfective_present_perfect("شد")]

    def passive_subjunctive_imperfective_present_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال کامل پایا در وجه التزامی در حالت مجهول.
        """

        return [ri+"ه "+x for x in self.subjunctive_imperfective_present_perfect("شد")]

    def negative_passive_subjunctive_imperfective_present_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال کامل پایا در وجه التزامی در حالت مجهول به‌شکل منفی.
        """

        return [ri+"ه "+x for x in self.negative_subjunctive_imperfective_present_perfect("شد")]

    def present_perfect_progressive(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال کامل استمراری.
        """

        return [x+" "+y for x, y in zip(self.present_perfect("داشت"), self.imperfective_present_perfect(ri))]

    def passive_present_perfect_progressive(self, ri):
    ...
    def past_precedent(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین.
        """

        return [ri+"ه "+x for x in self.perfective_past("بود")]

    def negative_past_precedent(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین به‌شکل منفی.
        """
        return ["ن"+x for x in self.past_precedent(ri)]

    def passive_past_precedent(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین در حالت مجهول.
        """

        return [ri+"ه "+x for x in self.past_precedent("شد")]

    def negative_passive_past_precedent(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین در حالت مجهول به‌شکل منفی.
        """

        return [ri+"ه "+x for x in self.negative_past_precedent("شد")]

    def imperfective_past_precedent(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین پایا.
        """

        return ["می‌"+x for x in self.past_precedent(ri)]

    def negative_imperfective_past_precedent(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین پایا به‌شکل منفی.
        """
        return ["ن"+x for x in self.imperfective_past_precedent(ri)]

    def passive_imperfective_past_precedent(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین پایا در حالت مجهول.
        """

        return [ri+"ه "+x for x in self.imperfective_past_precedent("شد")]

    def negative_passive_imperfective_past_precedent(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین پایا در حالت مجهول به‌شکل منفی.
        """

        return [ri+"ه "+x for x in self.negative_imperfective_past_precedent("شد")]

    def past_precedent_progressive(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین استمراری.
        """

        return [x + " " + y for x, y in zip(self.perfective_past("داشت"), self.imperfective_past_precedent(ri))]

    def passive_past_precedent_progressive(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین استمراری در حالت مجهول.
        """

        return [x + " " + y for x, y in zip(self.perfective_past("داشت"), self.passive_imperfective_past_precedent(ri))]

    def past_precedent_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین کامل.
        """

        return [ri+"ه "+x for x in self.present_perfect("بود")]

    def negative_past_precedent_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین کامل به‌شکل منفی.
        """
        return ["ن"+x for x in self.past_precedent_perfect(ri)]

    def subjunctive_past_precedent_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین کامل در وجه التزامی.
        """

        return [ri+"ه "+x for x in self.subjunctive_present_perfect("بود")]

    def negative_subjunctive_past_precedent_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین کامل در وجه التزامی به‌شکل منفی.
        """

        return ["ن"+x for x in self.subjunctive_past_precedent_perfect(ri)]
    
    def grammatical_past_precedent_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین کامل در وجه دستوری.
        """

        return [ri+"ه بوده "+("باش" if x == "باشی" else x) for x in self.perfective_present("باش")]

    def negative_grammatical_past_precedent_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین کامل در وجه دستوری به‌شکل منفی.
        """

        return ["ن" + x for x in self.grammatical_past_precedent_perfect(ri)]
    
    def passive_past_precedent_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین کامل در حالت مجهول.
        """

        return [ri+"ه "+x for x in self.past_precedent_perfect("شد")]

    def negative_passive_past_precedent_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین کامل در حالت مجهول به‌شکل منفی.
        """

        return [ri+"ه "+x for x in self.negative_past_precedent_perfect("شد")]

    def passive_subjunctive_past_precedent_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین کامل در وجه التزامی در حالت مجهول.
        """

        return [ri+"ه "+x for x in self.subjunctive_past_precedent_perfect("شد")]

    def negative_passive_subjunctive_past_precedent_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین کامل در وجه التزامی در حالت مجهول به‌شکل منفی.
        """

        return [ri+"ه "+"ن"+x for x in self.subjunctive_past_precedent_perfect("شد")]

    def passive_grammatical_past_precedent_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین کامل در وجه دستوری در حالت مجهول.
        """

        return [ri+"ه " + x for x in self.grammatical_past_precedent_perfect("شد")]

    def negative_passive_grammatical_past_precedent_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین کامل در وجه دستوری در حالت مجهول به‌شکل منفی.
        """

        return [ri+"ه "+x for x in self.negative_grammatical_past_precedent_perfect("شد")]

    def imperfective_past_precedent_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین کامل پایا.
        """

        return ["می‌"+x for x in self.past_precedent_perfect(ri)]

    def negative_imperfective_past_precedent_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین کامل پایا به‌شکل منفی.
        """
        return ["ن"+x for x in self.imperfective_past_precedent_perfect(ri)]

    def subjunctive_imperfective_past_precedent_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین کامل پایا در وجه التزامی.
        """

        return ["می‌"+x for x in self.subjunctive_past_precedent_perfect(ri)]

    def negative_subjunctive_imperfective_past_precedent_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین کامل پایا در وجه التزامی به‌شکل منفی.
        """

        return ["ن"+x for x in self.subjunctive_imperfective_past_precedent_perfect(ri)]

    def passive_imperfective_past_precedent_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین کامل پایا در حالت مجهول.
        """

        return [ri+"ه "+x for x in self.imperfective_past_precedent_perfect("شد")]
    
    def negative_passive_imperfective_past_precedent_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین کامل پایا در حالت مجهول به‌شکل منفی.
        """

        return [ri+"ه "+x for x in self.negative_imperfective_past_precedent_perfect("شد")]
    
    def passive_subjunctive_imperfective_past_precedent_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین کامل پایا در وجه التزامی در حالت مجهول.
        """

        return [ri+"ه "+x for x in self.subjunctive_imperfective_past_precedent_perfect("شد")]

    def negative_passive_subjunctive_imperfective_past_precedent_perfect(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین کامل پایا در وجه التزامی در حالت مجهول به‌شکل منفی.
        """

        return [ri+"ه "+"ن"+x for x in self.subjunctive_imperfective_past_precedent_perfect("شد")]
    
    def past_precedent_perfect_progressive(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین کامل استمراری.
        """

        return [x+" "+y for x, y in zip(self.present_perfect('داشت'), self.imperfective_past_precedent_perfect(ri))]

    def passive_past_precedent_perfect_progressive(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان گذشتهٔ پیشین کامل استمراری در حالت مجهول.
        """
    ...
    def perfective_present(self, rii):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال مطلق.
        """
    ...
    def negative_perfective_present(self, rii):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال مطلق به‌شکل منفی.
        """
    ...
    def subjunctive_perfective_present(self, rii):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال مطلق در وجه التزامی.
        """
    ...
    def negative_subjunctive_perfective_present(self, rii):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال مطلق در وجه التزامی به‌شکل منفی.
        """
    ...
    def grammatical_perfective_present(self, rii):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال مطلق در وجه دستوری.
        """
    ...
    def negative_grammatical_perfective_present(self, rii):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال مطلق در وجه دستوری به‌شکل منفی.
        """

        return ["ن" + ("بین" if x == "بینی" else x) for x in self.perfective_present(rii)]
    
    def passive_perfective_present(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال مطلق در حالت مجهول.
        """

        return [ri+"ه "+x for x in self.perfective_present("شو")]

    def negative_passive_perfective_present(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال مطلق در حالت مجهول به‌شکل منفی.
        """

        return [ri+"ه "+x for x in self.negative_perfective_present("شو")]

    def passive_subjunctive_perfective_present(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال مطلق در وجه التزامی در حالت مجهول.
        """

        return [ri+"ه "+x for x in self.subjunctive_perfective_present("شو")]

    def negative_passive_subjunctive_perfective_present(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال مطلق در وجه التزامی در حالت مجهول به‌شکل منفی.
        """

        return [ri+"ه "+x for x in self.negative_subjunctive_perfective_present("شو")]

    def passive_grammatical_perfective_present(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال مطلق در وجه دستوری در حالت مجهول.
        """

        return [ri+"ه " + ("بشو" if x == "بشوی" else x) for x in self.grammatical_perfective_present("شو")]

    def negative_passive_grammatical_perfective_present(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال مطلق در وجه دستوری در حالت مجهول به‌شکل منفی.
        """
    ...
    def imperfective_present(self, rii):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال پایا.
        """
    ...
    def negative_imperfective_present(self, rii):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال پایا به‌شکل منفی.
        """
        return ["ن"+x for x in self.imperfective_present(rii)]

    def passive_imperfective_present(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال پایا در حالت مجهول.
        """

        return [ri+"ه "+x for x in self.imperfective_present("شو")]

    def negative_passive_imperfective_present(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال پایا در حالت مجهول به‌شکل منفی.
        """
    ...
    def present_progressive(self, rii):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال استمراری.
        """

        return [x+" "+y for x, y in zip(self.perfective_present('دار'), self.imperfective_present(rii))]

    def passive_present_progressive(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان حال استمراری در حالت مجهول.
        """

        return [x+" "+y for x, y in zip(self.perfective_present('دار'), self.passive_imperfective_present(ri))]

    def perfective_future(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان آیندهٔ مطلق.
        """

        return [x+" "+ri for x in self.perfective_present("خواه")]

    def negative_perfective_future(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان آیندهٔ مطلق به‌شکل منفی.
        """
        return ["ن"+x for x in self.perfective_future(ri)]

    def passive_perfective_future(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان آیندهٔ مطلق در حالت مجهول.
        """

        return [ri+"ه "+x for x in self.perfective_future("شد")]

    def negative_passive_perfective_future(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان آیندهٔ مطلق در حالت مجهول به‌شکل منفی.
        """

        return [ri+"ه "+x for x in self.negative_perfective_future("شد")]

    def imperfective_future(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان آیندهٔ پایا.
        """

        return ["می‌"+x for x in self.perfective_future(ri)]

    def negative_imperfective_future(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان آیندهٔ پایا به‌شکل منفی.
        """
        return ["ن"+x for x in self.imperfective_future(ri)]

    def passive_imperfective_future(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان آیندهٔ پایا در حالت مجهول.
        """

        return [ri+"ه "+x for x in self.imperfective_future("شد")]

    def negative_passive_imperfective_future(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان آیندهٔ پایا در حالت مجهول به‌شکل منفی.
        """

        return [ri+"ه "+x for x in self.negative_imperfective_future("شد")]

    def future_precedent(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان آیندهٔ پیشین.
        """

        return [ri+"ه "+x for x in self.perfective_future("بود")]

    def negative_future_precedent(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان آیندهٔ پیشین به‌شکل منفی.
        """
        return ["ن"+x for x in self.future_precedent(ri)]

    def passive_future_precedent(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان آیندهٔ پیشین در حالت مجهول.
        """

        return [ri+"ه "+x for x in self.future_precedent("شد")]

    def negative_passive_future_precedent(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان آیندهٔ پیشین در حالت مجهول به‌شکل منفی.
        """

        return [ri+"ه "+x for x in self.negative_future_precedent("شد")]

    def future_precedent_imperfective(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان آیندهٔ پیشین پایا.
        """

        return ["می‌"+x for x in self.future_precedent(ri)]

    def negative_future_precedent_imperfective(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان آیندهٔ پیشین پایا به‌شکل منفی.
        """
        return ["ن"+x for x in self.future_precedent_imperfective(ri)]

    def passive_future_precedent_imperfective(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان آیندهٔ پیشین پایا در حالت مجهول.
        """

        return [ri+"ه "+x for x in self.future_precedent_imperfective("شد")]

    def negative_passive_future_precedent_imperfective(self, ri):
        ...
        Returns:
            (List[str]): صورت‌های صرفی فعل در زمان آیندهٔ پیشین پایا در حالت مجهول به‌شکل منفی.
        """

        return [ri+"ه "+x for x in self.negative_future_precedent_imperfective("شد")]
    
    def get(self, verb, negative=False, passive=False):
        """صورت‌های صرفی فعل را برمی‌گرداند.
    ...
    def get_all(self, verb):
        ...
        Returns:
            (List[str]): لیست تمام صورت‌های صرفی فعل.
        """
        ri, rii = verb.split("#")
        infinitive = [ri + "ن"]
        result = [infinitive]
        ...
        result.append(
            self.negative_subjunctive_imperfective_present_perfect(ri))
        ...
        result.append(
            self.passive_subjunctive_imperfective_present_perfect(ri))
        ...
        result.append(
            self.negative_passive_subjunctive_past_precedent_perfect(ri))
        ...
        result.append(
            self.negative_passive_grammatical_past_precedent_perfect(ri))
        ...
        result.append(
            self.negative_passive_imperfective_past_precedent_perfect(ri))
