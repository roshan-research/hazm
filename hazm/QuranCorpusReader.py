...
buckwalter_transliteration = maketrans("'>&<}AbptvjHxd"
                                       "*rzs$SDTZEg_fqklmnhwYyFNKaui~o^#`{"
                                       ":@\"[;,.!-+%]",
                                       "\u0621\u0623\u0624\u0625\u0626\u0627"
                                       "\u0628\u0629\u062a\u062b\u062c\u062d"
                                       "\u062e\u062f\u0630\u0631\u0632\u0633"
...
class QuranCorpusReader():
    """
    interfaces [Quran Corpus](http://corpus.quran.com/download/)
        ...
        for line in codecs.open(self._quran_file):
            ...
            for feature in features:
                if feature.startswith('LEM:'):
                    part['lem'] = feature[4:].translate(
                        buckwalter_transliteration)
                elif feature.startswith('ROOT:'):
                    part['root'] = feature[5:].translate(
                        buckwalter_transliteration)
            yield part
