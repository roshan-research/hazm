...
buckwalter_transliteration = maketrans("'>&<}AbptvjHxd*rzs$SDTZEg_fqklmnhwYyFNKaui~o^#`{:@\"[;,.!-+%]",
...
class QuranCorpusReader():
    ...
    def parts(self):
        for line in codecs.open(self._quran_file):
            ...
            part = {'loc': eval(parts[0].replace(':', ',')), 'text': parts[1].translate(buckwalter_transliteration),
                    'tag': parts[2]}
