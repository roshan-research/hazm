                ...
                (t.Index.prototype.query = function (e) {
                    ...
                    for (var u = 0; u < r.clauses.length; u++) {
                        var c = r.clauses[u],
                            ...
                            y = t.Set.empty;
                        c.usePipeline
                            ? (h = this.pipeline.runString(c.term, {
                                  fields: c.fields,
                              }))
                            : (h = [c.term]);
                    ...
                    for (var s = 0; s < i.length; s++) {
                        ...
                        for (var b = 0; b < h.length; b++) {
                            ...
                            this.invertedIndex[m][o][n] == null &&
                                (this.invertedIndex[m][o][n] =
                                    Object.create(null));
                            for (
                                var d = 0;
                                d < this.metadataWhitelist.length;
                                d++
                            ) {
    ...
    function se(t) {
        ...
        for (let n of t) {
            ...
            if (s) {
                ...
                e.set(
                    o,
                    M({ location: o, title: a, text: c }, u && { tags: u })
                );
        }
        return e;
    }
        ...
        constructor({ config: e, docs: r, options: n }) {
            (this.options = n),
                ...
                (this.index = lunr(function () {
                    ...
                    for (let s of e.lang.map((o) =>
                        o === "en" ? lunr : lunr[o]
                    ))
                        for (let o of i)
                            this.pipeline.remove(s[o]),
                                this.searchPipeline.remove(s[o]);
                    this.ref("location"),
            ...
            if (e)
                try {
                    ...
                    if (this.options.suggestions) {
                        ...
                        s = o.length
                            ? Object.keys(o[0].matchData.metadata)
                            : [];
                    }
                    return M(
                        { items: [...i.values()] },
