...
class TestWordTokenizer:
    ...
    @pytest.fixture()
    def tokenizer(word_tokenizer):
        word_tokenizer._join_verb_parts = True
    ...
    def test_tokenize_simple_sentence(self, word_tokenizer):        
        actual = word_tokenizer.tokenize('این جمله (خیلی) پیچیده نیست!!!')
        expected = ['این', 'جمله', '(', 'خیلی', ')', 'پیچیده', 'نیست', '!!!']
        assert actual==expected


    def test_tokenize_when_join_verb_parts_is_false(self, word_tokenizer):
        word_tokenizer._join_verb_parts = False
        actual = ' '.join(word_tokenizer.tokenize('سلام.'))
        expected = 'سلام .'
        assert actual==expected

    def test_tokenize_when_join_verb_parts_is_false_and_replace_links_is_true(self, word_tokenizer):
    ...
    def test_tokenize_when_join_verb_parts_is_false_and_replace_ids_and_replace_numbers_is_true(self, word_tokenizer):
    ...
    def test_tokenize_when_join_verb_parts_is_false_and_separate_emoji_is_true(self, word_tokenizer):                
    ...
    def test_join_verb_parts(self, word_tokenizer, words, expected):
