...
class TestNormazlier:
    ...
    @pytest.mark.parametrize(("text", "expected"), [
        ...
        # No ZWNJ after a non-left-joining letter, where it would be invisible.
        ("بندر ها", "بندرها"),
        ("دانشجو ها", "دانشجوها"),
        ("مداد ها", "مدادها"),
        ("مرز ها", "مرزها"),
        ("دور تر", "دورتر"),
        # A ZWNJ is still required after a left-joining letter.
        ("کتاب ها", "کتاب‌ها"),
        ("بزرگ ترین", "بزرگ‌ترین"),
        ("   (سلام)", "(سلام)"),
        ("(سلام)   ", "(سلام)"),
    ...
    @pytest.mark.parametrize(("text", "expected"), [
        ...
        # A ZWNJ is invisible after a non-left-joining letter, so the suffix
